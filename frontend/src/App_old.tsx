...
import { Activity, TrendingUp, Database, Settings, Play, Square, BarChart3, TestTube, FolderOpen } from 'lucide-react'
      ...
      <div className="border-b">
        <div className="flex h-16 items-center px-4">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-semibold">Bot Forge System</h1>
          </div>
