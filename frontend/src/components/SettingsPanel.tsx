...
const SettingsPanel: React.FC<SettingsPanelProps> = ({ selectedExchange }) => {
  ...
  const handleInputChange = (exchange: string, field: keyof ApiKeyData, value: string | boolean) => {
    setApiKeys(prev => ({
      ...prev,
      [exchange]: {
        ...prev[exchange],
    ...
    return (
      <Card key={exchangeId} className="w-full">
        ...
        <CardContent className="space-y-4">
          <form onSubmit={(e) => { e.preventDefault(); saveApiKey(exchangeId); }}>
            <div className="grid grid-cols-1 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange(exchangeId, 'api_key', e.target.value)}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange(exchangeId, 'api_secret', e.target.value)}
                />
              </div>
              ...
              {exchangeInfo.hasPassphrase && (
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange(exchangeId, 'passphrase', e.target.value)}
                  />
                </div>
              )}
              ...
              {exchangeInfo.hasSandbox && (
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor={`${exchangeId}-sandbox`}>サンドボックスモード</Label>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleInputChange(exchangeId, 'sandbox_mode', checked)}
                  />
                </div>
              )}
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleInputChange(exchangeId, 'is_active', checked)}
                />
              </div>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2 text-sm text-muted-foreground">
            ...
            <p>• サンドボックスモードでテストしてから本番環境で使用してください</p>
          </div>
        </CardContent>
      </Card>
    </div>
