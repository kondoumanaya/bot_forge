...
export default function BacktestPanel({ exchange, symbol }: BacktestPanelProps) {
  const [strategyName, setStrategyName] = useState<string>('simple_ma_crossover')
  ...
  const tradeDistribution = result ? [
    { type: 'Wins', count: Math.floor(result.total_trades * result.win_rate) },
    { type: 'Losses', count: result.total_trades - Math.floor(result.total_trades * result.win_rate) },
  ] : []
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select value={strategyName} onValueChange={setStrategyName}>
                ...
                <SelectContent>
                  <SelectItem value="simple_ma_crossover">Simple MA Crossover</SelectItem>
                  ...
                  <SelectItem value="momentum_strategy">Momentum Strategy</SelectItem>
                </SelectContent>
              </Select>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <p className="text-sm font-medium">Target: {symbol} on {exchange.toUpperCase()}</p>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  ¥{(result.final_balance - result.initial_balance).toLocaleString()} profit
                </p>
              </CardContent>
            </Card>
                ...
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={performanceData}>
                      ...
                      <YAxis />
                      <Tooltip />
                      <Line type="monotone" dataKey="pnl" stroke="#22c55e" strokeWidth={2} name="P&L" />
